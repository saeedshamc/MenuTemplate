...
export default function App() {
  const [theme, setTheme] = useState(() => localStorage.getItem('blackgrill-theme') || 'light')
  ...
  const {
    ...
    reset,
    store,
  } = useMenuStore('blackgrill', DEFAULT_SETTINGS)
  ...
  return (
    <div className="app-wrapper">
      ...
      {adminOpen && (
        <AdminPanel
          brandName={settings.brandName || "بلک‌گریل"}
          products={products}
