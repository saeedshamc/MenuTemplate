    ...
    <div className="app-wrapper">
      <section className="hero">
        ...
        <div className="hero-content">
          <Logo size={88} />
          <p className="eyebrow">Specialty Coffee · Single Origin</p>
          <h1>نورقهوه</h1>
          <p className="tagline">قهوهٔ اسپشیالتی — رُست تازه، دم‌آوری دقیق، لحظه‌ای آرام</p>
        </div>
      </section>
      ...
      <div className="app">
        ...
        <footer className="footer">
          <strong>نورقهوه</strong>
          <span>Specialty Coffee · از ساعت ۸ تا ۲۲</span>
        </footer>
      </div>
    </div>
  )
