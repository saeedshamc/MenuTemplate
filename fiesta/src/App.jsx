...
export default function App() {
  const [theme, setTheme] = useState(() => localStorage.getItem('fiesta-theme') || 'light')
  ...
  const {
    ...
    reset,
    store,
  } = useMenuStore('fiesta', DEFAULT_SETTINGS)

  useEffect(() => {
    document.documentElement.setAttribute('data-theme', theme)
    localStorage.setItem('fiesta-theme', theme)
  }, [theme])
  ...
  return (
    <div className="app-wrapper">
      ...
      {adminOpen && (
        <AdminPanel
          brandName={settings.brandName || "فیستا"}
          products={products}
