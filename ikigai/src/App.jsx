...
export default function App() {
  const [theme, setTheme] = useState(() => localStorage.getItem('ikigai-theme') || 'light')
  const [query, setQuery] = useState('')
  const [category, setCategory] = useState('all')

  useEffect(() => {
    document.documentElement.setAttribute('data-theme', theme)
    localStorage.setItem('ikigai-theme', theme)
  }, [theme])
    ...
    <div className="app-wrapper">
      <section className="hero">
        ...
        <div className="hero-content">
          <Logo size={88} />
          <p className="eyebrow">Omakase · Fresh Daily</p>
          <h1>ایکیگای</h1>
          <p className="tagline">سوشی مینیمال، ماهی تازه هر روز — آرامش در هر لقمه</p>
        </div>
      </section>
